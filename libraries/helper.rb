  ...
  module Aixtoolbox
    module Helper
      ...
      @pkgmap = {
        ...
        'bash-doc' => { :version => '4.2-1', :rpm => 'bash/bash-doc-4.2-1.aix6.1.ppc.rpm' },
        'bash' => { :version => '4.2-1', :rpm => 'bash/bash-4.2-1.aix6.1.ppc.rpm' },
        ...
        'cdrecord-devel' => { :version => '1.9-7', :rpm => 'cdrecord/cdrecord-devel-1.9-7.aix5.2.ppc.rpm' },
        'cdrecord-devel' => { :version => '1.9-9', :rpm => 'cdrecord/cdrecord-devel-1.9-9.aix5.3.ppc.rpm' },
        'cdrecord' => { :version => '1.9-7', :rpm => 'cdrecord/cdrecord-1.9-7.aix5.2.ppc.rpm' },
        ...
        'gcc-c++' => { :version => '4.2.0-3', :rpm => 'gcc/gcc-cplusplus-4.2.0-3.aix5.3.ppc.rpm' },
        'gcc-c++' => { :version => '4.2.0-3', :rpm => 'gcc/gcc-cplusplus-4.2.0-3.aix6.1.ppc.rpm' },
        'gcc-gij' => { :version => '4.2.0-3', :rpm => 'gcc/gcc-gij-4.2.0-3.aix5.3.ppc.rpm' },
        'gcc-gij' => { :version => '4.2.0-3', :rpm => 'gcc/gcc-gij-4.2.0-3.aix6.1.ppc.rpm' },
        'gcc-java' => { :version => '4.2.0-3', :rpm => 'gcc/gcc-java-4.2.0-3.aix5.3.ppc.rpm' },
        'gcc-java' => { :version => '4.2.0-3', :rpm => 'gcc/gcc-java-4.2.0-3.aix6.1.ppc.rpm' },
        'gcc-locale' => { :version => '4.2.0-3', :rpm => 'gcc/gcc-locale-4.2.0-3.aix5.3.ppc.rpm' },
        'gcc-locale' => { :version => '4.2.0-3', :rpm => 'gcc/gcc-locale-4.2.0-3.aix6.1.ppc.rpm' },
        'gcc' => { :version => '4.2.0-3', :rpm => 'gcc/gcc-4.2.0-3.aix5.3.ppc.rpm' },
        ...
        'libffi-devel' => { :version => '4.2.0-3', :rpm => 'gcc/libffi-devel-4.2.0-3.aix5.3.ppc.rpm' },
        'libffi-devel' => { :version => '4.2.0-3', :rpm => 'gcc/libffi-devel-4.2.0-3.aix6.1.ppc.rpm' },
        'libffi' => { :version => '4.2.0-3', :rpm => 'gcc/libffi-4.2.0-3.aix5.3.ppc.rpm' },
        ...
        'libgcc' => { :version => '4.2.0-3', :rpm => 'gcc/libgcc-4.2.0-3.aix5.3.ppc.rpm' },
        'libgcc' => { :version => '4.2.0-3', :rpm => 'gcc/libgcc-4.2.0-3.aix6.1.ppc.rpm' },
        'libgcj-devel' => { :version => '4.2.0-3', :rpm => 'gcc/libgcj-devel-4.2.0-3.aix5.3.ppc.rpm' },
        'libgcj-devel' => { :version => '4.2.0-3', :rpm => 'gcc/libgcj-devel-4.2.0-3.aix6.1.ppc.rpm' },
        'libgcj' => { :version => '4.2.0-3', :rpm => 'gcc/libgcj-4.2.0-3.aix5.3.ppc.rpm' },
        ...
        'libgomp' => { :version => '4.2.0-3', :rpm => 'gcc/libgomp-4.2.0-3.aix5.3.ppc.rpm' },
        ...
        'libstdc++-devel' => { :version => '4.2.0-3', :rpm => 'gcc/libstdcplusplus-devel-4.2.0-3.aix5.3.ppc.rpm' },
        'libstdc++-devel' => { :version => '4.2.0-3', :rpm => 'gcc/libstdcplusplus-devel-4.2.0-3.aix6.1.ppc.rpm' },
        'libstdc++' => { :version => '4.2.0-3', :rpm => 'gcc/libstdcplusplus-4.2.0-3.aix5.3.ppc.rpm' },
        ...
        'mkisofs' => { :version => '1.13-4', :rpm => 'cdrecord/mkisofs-1.13-4.aix4.3.ppc.rpm' },
        ...
        'xemacs-el' => { :version => '21.1.14-2', :rpm => 'xemacs/xemacs-el-21.1.14-2.aix5.2.ppc.rpm' },
        'xemacs-el' => { :version => '21.1.14-2', :rpm => 'xemacs/xemacs-el-21.1.14-2.aix6.1.ppc.rpm' },
        'xemacs-info' => { :version => '21.1.14-2', :rpm => 'xemacs/xemacs-info-21.1.14-2.aix5.2.ppc.rpm' },
        'xemacs-info' => { :version => '21.1.14-2', :rpm => 'xemacs/xemacs-info-21.1.14-2.aix6.1.ppc.rpm' },
        'xemacs' => { :version => '21.1.14-2', :rpm => 'xemacs/xemacs-21.1.14-2.aix5.2.ppc.rpm' },
        ...
        'xpm-devel' => { :version => '3.4k-8', :rpm => 'xpm/xpm-devel-3.4k-8.aix5.2.ppc.rpm' },
