# Expected values
# return code : 0
# suma log info : INFO: List of targets expanded to ["client21", "client22", "client23"]
# suma directory : /sumatest/targets/wildcard3/7100-01-01-1316-lpp_source
...
aix_suma 'Valid client list with wildcard (0500-035)' do
  ...
  location  '/sumatest/targets/wildcard3'
  targets   'client2*'
  action    :download
end
