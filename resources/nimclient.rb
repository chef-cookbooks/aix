...
property :lpp_source, String, regex: [/next_sp/, /latest_sp/, /next_tl/, /latest_tl/, /[7100,6100,5300]-[0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]-lpp_source/, /.*-lpp_source/]
property :installp_bundle, String, regex: [/.*-installp_bundle/]
# Lists of filesets to install
property :filesets, Array
# fixes to install can be update_all for all
property :fixes, String
property :installp_flags, String
